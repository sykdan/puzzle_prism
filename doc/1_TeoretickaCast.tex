...
V oblasti \gls{vr} a případně \gls{mr} je klíčovým prvkem stereoskopické zobrazení. V principu headset každému oku zobrazuje jiný obraz, což vyvolává pocit hloubky a dělá tak VR přesvědčivou. Renderování tedy musí proběhnout dvakrát, pokaždé pod jiným úhlem. \cite{stereoskopie_diagram}
